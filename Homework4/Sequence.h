...
int subsequence(const Sequence<ItemType>& seq1, const Sequence<ItemType>& seq2);
      // If seq2 is a contiguous subsequence<ItemType> of seq1, return the position in
      // seq1 where that subsequence<ItemType> starts (the earliest such position if more
...
void interleave(const Sequence<ItemType>& seq1, const Sequence<ItemType>& seq2, Sequence<ItemType>& result); 
      // Set result to a Sequence<ItemType> that interleaves seq1 and seq2.
