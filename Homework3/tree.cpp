...
void order(std::string a[], int n)
{
	if(n > 1)
	{
		...
		int first = -1;
		int last = n;
		separate(a, n, a[mid], first, last);
		order(a, first);
		order(a + first, n - last);
	}
}

// int main()
// {
// 	std::string a[] = {"a", "d", "c", "e", "b"};
// 	std::string n1[] = {"stan", "kyle", "cartman", "kenny", "kyle", "cartman", "butters"};

// 	std::string n21[] = {"stan", "kenny", "cartman"};
// 	std::string n22[] = {"stan", "cartman", "butters"};                
// 	std::string n23[] = {"kenny", "stan", "cartman"};
// 	std::string n24[] = {"kyle", "cartman", "butters"};         
...
// 		std::cout << a[i] << ", ";
// 	}
// 	std::cout << countIncludes(n1, 7, n21, 3) << '\n';
// 	std::cout << countIncludes(n1, 7, n22, 3) << '\n';
// 	std::cout << countIncludes(n1, 7, n23, 3) << '\n';
// 	std::cout << countIncludes(n1, 7, n24, 3) << '\n';
